           ...
           <%-- Loop through the listManager and display each document --%>
            <% for (Document admin : listAdmin) { %>
                <tr>
                  ...
                  <td><a href="${pageContext.request.contextPath}/Admin/UpdateAdmin?id=<%= admin.get("N_admin") %>">Edit</a>
	&nbsp;&nbsp;&nbsp;&nbsp; <a>
                  <td><a href="${pageContext.request.contextPath}/Admin/delete?id=<%= admin.get("N_admin") %>">Delete</a>
