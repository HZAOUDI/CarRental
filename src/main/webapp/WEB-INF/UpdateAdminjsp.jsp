...
<div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1 class="m-0 text-dark">Modifier un admin</h1>
...
<form action="${pageContext.request.contextPath}/Admin/Update" method="post">
  ...
  <% Document Admin = (Document)request.getAttribute("Admin"); %>
	...
	<fieldset class="form-row col-md-6">
	 ...
	 <input type="hidden"
	 class="form-control"  value="<%= Admin.get("N_admin") %>"
   ...
   <fieldset class="form-row col-md-8">
	  <label >Email</label>
	 <input type="Email"
	 class="form-control" value="<%= Admin.get("Login") %>"
   ...
   <fieldset class="form-row col-md-8">
	 ...
	 <input type="Password"
	 class="form-control" value="<%= Admin.get("Password") %>"
